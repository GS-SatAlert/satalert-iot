...
1. Importe os arquivos `sketch.ino`, `diagram.json` e `library.txt` para o Wokwi [Wokwi](https://wokwi.com/).
   Ou se preferir entre no nosso projeto já pronto [Wokwi](https://wokwi.com/projects/465949480051578881).
